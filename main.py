...
from distance_functions import isomorphism_distance_adjmatrix, isomorphism_distance_adjmatrix_constrained
...
def run():
    ...
    # fractional_constrained_dist,  X, x_v_empty, x_empty_i, C = dist(path_two.x, path_two_adj,path_one.x, path_one_adj, 2)
    # print('################################')
    # print('distance:')
